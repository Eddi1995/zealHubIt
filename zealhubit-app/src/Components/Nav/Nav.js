...
<nav className="navbar navbar-expand-lg bg-body-tertiary text-primary ">
  ...
  <Link activeClass="active" spy={true} smooth={true} offset={-60} duration={100} to="Home"  className="navbar-brand text-warning fs-3 me-4" >Home</Link>
    ...
    <button  className="navbar-toggler bg-white fs-6" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
   ...
   <div className="collapse navbar-collapse  rounded-1 " id="navbarNavDropdown" >
     <ul class={Navstyle.NavList} className="navbar-nav fs-5" >
        ...
        <li className="nav-item">
          <Link activeClass="active" to="ServicesProduct" spy={true} smooth={true} offset={-32} duration={100} className="nav-link" aria-current="page">Services</Link>  {/* NOTE: This to="" which checks the application whether same id name given or not*/}
        </li>
        <li className="nav-item">
